...
**Primary Dependencies**: Linode Terraform provider, StackScript (cloud-init), HashiCorp Vault (AppRole), Vector + Loki for log shipping, PostgreSQL 15, Redis 7, NATS 2.x, MinIO, FastAPI mock inference container  
...
└── secrets-sync/                 # Go module hydrating .env.* from Vault
