...
// Note: CSV generation benchmarking requires access to internal exports package.
// This benchmark is a placeholder - actual implementation would require making
// generateCSV public or using a test helper function.
func BenchmarkCSVGenerationSmall(b *testing.B) {
	...
	// Placeholder benchmark - CSV generation would be benchmarked here
	// Actual implementation requires access to internal/exports package
	b.Skip("CSV generation benchmark requires internal package access")
}
