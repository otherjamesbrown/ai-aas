module github.com/otherjamesbrown/ai-aas/services/analytics-service/test/integration-phase5
...
require (
	...
	github.com/otherjamesbrown/ai-aas/shared/go v0.0.0-00010101000000-000000000000 // indirect
