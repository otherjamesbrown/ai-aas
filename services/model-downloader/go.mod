module github.com/otherjamesbrown/ai-aas/services/model-downloader

go 1.24.0

toolchain go1.24.2

require github.com/otherjamesbrown/ai-aas/shared/go v0.0.0-00010101000000-000000000000
