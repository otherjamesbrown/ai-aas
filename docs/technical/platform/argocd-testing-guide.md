...
- Read: `docs/technical/platform/ci-cd-pipeline.md` - Full CI/CD overview
- Read: `docs/technical/workflows/argocd-deployment-workflow.md` - ArgoCD workflow
...
- `docs/technical/platform/ci-cd-pipeline.md` - CI/CD pipeline overview
- `docs/technical/workflows/argocd-deployment-workflow.md` - ArgoCD deployment guide
