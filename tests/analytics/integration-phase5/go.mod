module github.com/otherjamesbrown/ai-aas/tests/analytics/integration-phase5
...
replace github.com/otherjamesbrown/ai-aas/services/analytics-service => ../../../services/analytics-service
